...
<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Home</li><li>Add New Author</li>
				</ol>
				<!-- end breadcrumb -->
			...
			<div id="content">
				...
				<%
				String ISBN=request.getParameter("ISBNnote");
				%>
										<form action="authorresult.jsp" class="smart-form">										
											<%
											//DB mysql = new DB();
		...
		%>
											...
											<!--  	<section>-->
													...
													<label class="input">
														<input type="text" name="AuthorName" value="" class="input-sm">
													</label>
											<!--  	</section>-->		
											<!--  	<section>-->
													<label class="label">Author ID</label>
													<label class="input">
														<input type="text" name="Authorid" value="" class="input-sm" >
													</label>
											<!--  	</section>-->
																				
									<!--  	<section>-->
													<label class="label">Author Age</label>
													<label class="input">
														<input type="text" name="Age" value="" class="input-sm">
													</label>
											<!--  	</section>-->
												
										<!--  	<section>-->
													<label class="label">Author Country</label>
													<label class="input">
														<input type="text" name="Country" value="" class="input-sm">
													</label>
												<!--  	</section>-->
