...
<body class="">
		...
		<div id="main" role="main" >
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Home</li><li>Author information</li>
				</ol>
				<!-- end breadcrumb -->
								...
								<div>
									...
									<div class="widget-body no-padding">
										...
										<table class="table table-bordered">
											...
											ResultSet rs = mysql.selectDayAlltrue(request);
											String fri1 = mysql.myDayAuthor1(request,userName1);
											ArrayList friends= (ArrayList)session.getAttribute("day1");
											...
											<%
												...
												{
													MyDayBean mm =(MyDayBean)friends.get(i);
